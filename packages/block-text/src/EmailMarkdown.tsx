...
${body}</tbody>
  ...
  paragraph(text: string) {
    return `<p style="margin-top: ${PARAGRAPH_TOP_PADDING_PX}px; margin-bottom: ${PARAGRAPH_BOTTOM_PADDING_PX}px;">${text}</p>
<!--[if mso]>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
  <tr><td height="${PARAGRAPH_BOTTOM_PADDING_PX}" style="line-height:${PARAGRAPH_BOTTOM_PADDING_PX}px;">&nbsp;</td></tr>
</table>
<![endif]-->`;
  }
}
